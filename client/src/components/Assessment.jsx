...
const getResult = (score) => {
  if (score <= 4)
    return {
      ...
      message:
        "Your responses suggest you're doing well overall. Keep practicing self-care and check in with yourself regularly.",
    };
  if (score <= 9)
    return {
      level: "Mild Depression",
      message:
        "You may be experiencing some symptoms. Consider reaching out to someone you trust or exploring self-care strategies.",
    };
  if (score <= 14)
    return {
      level: "Moderate Depression",
      message:
        "Your responses indicate significant symptoms. It may be helpful to speak with a counselor or mental health professional.",
    };
  if (score <= 19)
    return {
      level: "Moderately Severe Depression",
      message:
        "Your responses suggest substantial symptoms. We strongly recommend connecting with a mental health professional for support.",
    };
  return {
    level: "Severe Depression",
    message:
      "Your responses indicate severe symptoms. Please consider reaching out to a mental health professional or crisis service immediately.",
  };
};
          ...
          <div className="max-w-2xl mx-auto">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600 text-[15px]">
                This self-assessment is based on the PHQ-9 depression screening
                tool. It's not a diagnosis, but can help identify symptoms.
              </p>
            </div>
                  ...
                  <div className="mb-8">
                    ...
                    <div className="text-left mb-8">
                      <p className="text-gray-700 mb-4">
                        <strong>Remember:</strong> This screening is not a
                        diagnosis. Only a qualified professional can diagnose
                        depression. However, your responses suggest it might be
                        helpful to:
                      </p>
                      <ul className="list-disc pl-5 space-y-2 text-gray-600">
                        ...
                        {totalScore > 9 && (
                          <>
                            ...
                            <li>
                              Practice self-compassion and be patient with
                              yourself
                            </li>
                          </>
                        )}
